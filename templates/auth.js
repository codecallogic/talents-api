                                ...
                                <tr>
                                  <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px; background-color: #ffffff; border-radius: 8px;" valign="top" bgcolor="#ffffff">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 300; line-height: 28px; color: #1B1B1B; letter-spacing: -0.2px;" valign="top" align="center">Dear Talents Customer,<br><br>We have received a request to authorize this email address for use with Talents. If you requested this verification, please click on following button to confirm that you are authorized to use this email address:</td>
                                        </tr>
                                        <tr>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #9B9B9B; text-align: center;" valign="top">Your request will not be processed unless you confirm the address using this URL. This link expires 24 hours after your original verification request.<br><br>If you did NOT request to verify this email address, do not click on the button.&nbsp;<br><br>Sincerely, <br><br>Talents Team</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                                          ...
                                          <td style="padding: 5px 0;" valign="top" align="center">
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #ef1d4b" bgcolor="#ef1d4b" valign="top" align="center">
                                                    <a href="${process.env.CLIENT_URL}/talents?token=${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Activate Account</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
