exports.messageExpertEmail = (name, message, email) => {
  return {
    ...
    Message: {
      ...
      Body: {
        Text: {
          Data: "Email service from Talents. "
            + "This email was sent from Talents "
          ,
          Charset: "UTF-8" 
        },
        Html: {
          ...
          <body style="width: 100% !important; margin: 0; padding: 0; mso-line-height-rule: exactly; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: #f4f4f4" class="">
            ...
            <div style="display: none !important; visibility: hidden; opacity: 0; overflow: hidden; mso-hide: all; height: 0; width: 0; max-height: 0; max-width: 0; font-size: 1px; line-height: 1px; color: #151515;">This is a new message email notification from client ${name}</div>
                                ...
                                <tr>
                                  <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px; background-color: #ffffff; border-radius: 8px;" valign="top" bgcolor="#ffffff">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                      <tbody>
                                        <tr>
                                          <td class="pc-xs-fs-30 pc-xs-lh-42 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 900; line-height: 46px; letter-spacing: -0.6px; color: #151515; text-align: center;" valign="top">New Message!</td>
                                        </tr>
                                        <tr>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 300; line-height: 28px; color: #1B1B1B; letter-spacing: -0.2px;" valign="top" align="center">${message}</td>
                                        </tr>
                                        <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #ef1d4b" bgcolor="#ef1d4b" valign="top" align="center">
                                                    <a href="${process.env.CLIENT_URL}/experts" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Click here to Reply</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #9B9B9B; text-align: center;" valign="top">Message from: ${name}&nbsp;</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
